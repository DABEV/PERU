...
public class LevelGenerator : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            int RandomInt1 = Random.Range(0, 8);
            ...
            {
                GameObject TempTile1 = Instantiate(StartTile, transform);
                TempTile1.transform.position = new Vector3(0, 0, 39);
            }

            int RandomInt2 = Random.Range(0, 8);
            ...
            {
                GameObject TempTile2 = Instantiate(StartTile, transform);
                TempTile2.transform.position = new Vector3(0, 0, 47);
            }
